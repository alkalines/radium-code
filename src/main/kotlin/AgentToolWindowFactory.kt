...
private fun AgentToolWindowContent() {
    ...
    var selectedModel by remember { mutableStateOf("GPT-5.4") }
    ...
    } // for some reason the up icon is not indexed on the all icons so we have to get a litte rouge
...
private fun ToolbarChip(
    ...
    borderColor: Color,
    trailingIcon: org.jetbrains.jewel.ui.icon.IconKey? = null,
